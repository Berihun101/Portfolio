...
const Footer = () => {
    ...
    return(
        <footer className="py-12 text-center px-6 lg:px-24 md:px-8 xl:px-32 2xl:pl-96 bg-myColor_dark">

           <div className="grid md:grid-cols-4 grid-cols-1 gap-12">

            <div>
                <h2 className="text-white text-start text-3xl font-bold">Let's talk about</h2>
                <div className="mt-12 text-start"> Let's talk about some works to be done</div>
                <div className="text-start">
                <button className="mt-4 bg-myColor p-3 text-white rounded-xl">Learn more</button>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="#About">About</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="#services">Services</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="#Myprojects">Projects</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="#contact">Contact</Link>
            ...
            <div className="space-y-4">
                <h2 className="text-white text-start text-3xl font-bold">Services</h2>
                <div className="flex mt-12">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 text-second_color">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                  
                 </svg>
                 <Link className="text-text-myColor" href="/">Web Development</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="/">SEO</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="/">Web Scrpaing</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="/">Web Design</Link>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.9" stroke="currentColor" className="size-6 text-second_color">
                 ...
                 <Link className="text-text-myColor" href="/">Backend Development</Link>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498 4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 0 0-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0Z" />
                 ...
                 <p className="text-text-myColor">Ayat, Addis Ababa</p>
